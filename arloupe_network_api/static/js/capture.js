...
/**
 * 更新狀態顏色，但不覆蓋元素原本的版面 class。
 */
function setCaptureStatusClass(elementId, statusClass) {
...
async function loadCaptureStatus() {
  try {
    ...
    setCaptureStatusClass("captureStreaming", "danger");
    document.getElementById("captureRecording").textContent = "讀取失敗";
    setCaptureStatusClass("captureRecording", "danger");
